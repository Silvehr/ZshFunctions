...
struct string_split_iterator
{
    ...
    public:
        ...
        bool move_next()
        {
            ...
            if (split_end == str_len) return false;
        ...
        beginning:
            ...
            while (split_end < str_len)
            {
                ...
                {
                    if (split_end - split_beg == 0) goto beginning;
                    return true;
                }
                split_end++;
            }
        ...
        string_split current() const { return string_split(&str[split_beg], split_end - split_beg); }
};
...
int main(int argc, char **argv)
{
    ...
    for (int argv_index = 1; argv_index < argc; argv_index++)
    {
        ...
        while (iter.move_next())
        {
            ...
            else { path_part_array[path_part_array_index++] = current; }
        }
    }

    if (path_part_array_index <= 0) { std::cout << "/\n"; }
    else
    {
